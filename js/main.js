...
function nodeActive(a) {
    ...
    if (f.attributes) {
        ...
        if (image_attribute) {
        	...
        	$GP.info_name.html("<div><span onmouseover=\"sigInst._core.plotter.drawHoverNode(sigInst._core.graph.nodesIndex['" + b.name + '\'])" onmouseout="sigInst.refresh()">' + b.label + "</span></div>");
        }
