...
function nodeActive(a) {
    ...
    if (f.attributes) {
        ...
        if (image_attribute) {
        	...
        	$GP.info_name.html("<div><img src=" + f.attributes[image_attribute] + " style=\"vertical-align:middle\" /> <span onmouseover=\"sigInst._core.plotter.drawHoverNode(sigInst._core.graph.nodesIndex['" + f.attr.attributes.name + '\'])" onmouseout="sigInst.refresh()">' + f.attributes.name + "</span></div>");
        } else {
